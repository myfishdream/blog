<template>
  ...
  <div class="articlelink">
    ...
    <div class="tobeebee" v-if="work?.yuucode || work?.linkpan"><a class="a vp-external-link-icon"
        :href="work?.yuucode ? theme.yuucodeurl + work?.yuucode + '.htm' : work?.linkpan" target="_blank"><span>备用下载</span></a>
    </div>
